...
\subsection{Pareto-Type II Distribution}
...
Cena A., Gagolewski M., OM3: ordered maxitive, minitive, and modular aggregation operators – Part I: Axiomatic analysis under arity-dependence (AGOP 2013).

\bibitem{CenaGagolewski2013:agop2}
Cena A., Gagolewski M., OM3: ordered maxitive, minitive, and modular aggregation operators – Part II: A simulation study (AGOP 2013).
...
Gagolewski M., Grzegorzewski P., Arity-Monotonic Extended Aggregation Operators, In: H\"{u}llermeier E., Kruse R., Hoffmann F. (Eds.), Information Processing and Management of Uncertainty in Knowledge-Based Systems (CCIS 80), Springer-Verlag, Heidelberg, 2010, pp. 693-702.
