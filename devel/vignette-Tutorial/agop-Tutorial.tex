...
\bibitem{CastilloDaoudi2009:mlegpd}
...
\bibitem{FranceschiniMaisano2011:structevalh}
...
\bibitem{GagolewskiGrzegorzewski2011:ijar}
...
\bibitem{Quesada2009:monotonicityh}
Quesada A.,
\newblock Monotonicity and the {H}irsch index.
\newblock \textit{Journal of Informetrics}, 3\penalty0 (2), pp.~158--160, 2009.

\bibitem{Quesada2010:moreaxiomatics}
Quesada A.,
\newblock More axiomatics for the {H}irsch index.
\newblock \textit{Scientometrics}, 82, pp.~413--418, 2010.

\bibitem{Rproject:home}
...
\bibitem{VillasenorGonzalez2009:gofgpd}
Villasenor-Alva J., Gonzalez-Estrada E.,
\newblock A bootstrap goodness of fit test for the {G}eneralized {P}areto
  {D}istribution.
\newblock \textit{Computational Statistics and Data Analysis}, 53\penalty0
  (11), pp.~3835--3841, 2009.

\bibitem{Woeginger2008:axiomaticg}
Woeginger G.J.,
\newblock An axiomatic analysis of {E}gghe's $g$-index.
\newblock \textit{Journal of Informetrics}, 2\penalty0 (4), pp.~364--368,
  2008.

\bibitem{Woeginger2008:axiomatich}
Woeginger G.J.,
\newblock An axiomatic characterization of the {H}irsch-index.
\newblock \textit{Mathematical Social Sciences}, 56\penalty0 (2), pp.~224--232,
  2008.

\bibitem{Woeginger2008:symmetryaxiom}
Woeginger G.J.,
\newblock A symmetry axiom for scientific impact indices.
\newblock \textit{Journal of Informetrics}, 2, pp.~298--303, 2008.
  
\bibitem{Zhang2010:estgpd}
Zhang J.,
\newblock Improving on estimation for the {G}eneralized {P}areto
  {D}istribution.
\newblock \textit{Technometrics}, 52\penalty0 (3), pp.~335--339, 2010.

\bibitem{ZhangStevens2009:estgpd}
Zhang J., Stephens M.A.,
\newblock A new and efficient estimation method for the {G}eneralized {P}areto
  {D}istribution.
\newblock \textit{Technometrics}, 51\penalty0 (3), pp.~316--325, 2009.
\end{thebibliography}
