...
\paragraph{Hirsch's $h$-index and its distribution.}

The exact distribution of $\func{H}$ is given by the following theorem, 
see.~\cite{Gagolewski2012:smps} for the proof.
