...
...TO DO... see \cite{GagolewskiXXXX:dispersion} ...
...
The \package{agop} package includes many functions
...
Irreflexivity & TO DO \\
Symmetry     & $(\forall i,j)$ $v_i R v_j \Rightarrow v_j R v_i$ & TO DO \\%\index{rel\_is\_symmetric()}\Rfunc{rel\_is\_symmetric()} \\
Antisymmetry & TO DO \\
Asymmetry & TO DO \\
...
To find the transitive closure of a given binary relation
...
determined using the \index{\Rfunc{pord\_weakdom()}}\Rfunc{pord\_weakdom()}
function.
...
The functions \index{\Rfunc{pord\_spread()}}\Rfunc{pord\_spread()}
and \index{\Rfunc{pord\_spreadsym()}}\Rfunc{pord\_spreadsym()}
...
\item The \emph{ordered weighted maximum} (cf.~\cite{DuboisETAL1988:wfpm})
associated with $\vect{w}$,
