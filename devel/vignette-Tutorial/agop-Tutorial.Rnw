...
Irreflexivity & TO DO \\
Symmetry     & $(\forall i,j)$ $v_i R v_j \Rightarrow v_j R v_i$ & \index{rel\_is\_symmetric()}\Rfunc{rel\_is\_symmetric()} \\
Antisymmetry & TO DO \\
Asymmetry & TO DO \\
...
\emph{fair total closure}, see \cite{Gagolewski2013:fair},
